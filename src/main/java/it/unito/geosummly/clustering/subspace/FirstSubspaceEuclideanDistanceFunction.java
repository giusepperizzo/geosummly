...
public class FirstSubspaceEuclideanDistanceFunction extends SubspaceLPNormDistanceFunction {
  ...
  public double doubleDistance(NumberVector<?> v1, NumberVector<?> v2) {
    ...
    if( v1.doubleValue(2) == v1.doubleValue(2) && v1.doubleValue(2) == 0) 
  ...
  public static class Parameterizer extends AbstractDimensionsSelectingDoubleDistanceFunction.Parameterizer {
    @Override
    protected FirstSubspaceEuclideanDistanceFunction makeInstance() {
      return new FirstSubspaceEuclideanDistanceFunction(dimensions);
    }
  }
}