...
public class GeoJSONDataWriter {
    ...
    public GeoJSONDataWriter() {}
    
    public void writeJsonStream(HashMap<Integer, String> labels, HashMap<Integer, ArrayList<ArrayList<Double>>> cells, HashMap<Integer, ArrayList<ArrayList<String>>> venues, double eps, String output) throws IOException {
        
    	OutputStream os= new FileOutputStream(new File(output+"/clustering-output.geojson"));
